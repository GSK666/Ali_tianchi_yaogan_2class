...
train_params = {
    ...
    'fit_policy' : {
       'stage-0' : {'freeze_to':0, 'lr':'%s' % default_lr, 'epochs':120, 'wd':None},
    ...
    'callbacks' : {
        ...
        'SaveModelCallback':{
            ...
            'fname':'unet++_b8_120_attention_yaogan_best_model',
        }
    }
}
...
if __name__ == '__main__':
    ...
    shutil.copy(path/'models'/'stage-0_unet++_b8_120_attention_yaogan_best_model.pth', model_parh/'stage-0_unet++_b8_120_attention_yaogan_best_model.pth')
